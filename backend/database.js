/**
 * DENYQUIZ INTERNAL DATABASE v3.0 (ROBUSTECIDO)
 * Release: Production Candidate
 * Curator: Otaku Engineer Lead
 *
 * OBJETIVO: Servir como um verdadeiro hub de conhecimento otaku com mais de 5000 perguntas.
 *
 * ESTRUTURA DE DADOS ROBUSTA:
 * - id: string (formato: "anime_nivel_numero_sequencial") - Ex: "op_ez_001", "naruto_hd_042"
 * - level: 'easy' | 'medium' | 'hard' (Genin, Chunin, Jonin)
 * - type: 'character' | 'technique' | 'lore' | 'world' | 'author' | 'seiyuu' | 'studio' | 'music' | 'trivia'
 * - anime: string (Nome canônico do anime/franquia para fácil filtragem)
 * - question: string (Pergunta clara e objetiva)
 * - image: string (URL direta para imagem de alta qualidade - priorizando MAL e fanart consistente)
 * - options: [string, string, string, string] (Array de 4 opções)
 * - correct: string (A opção correta, idêntica à string no array de options)
 * - tags: string[] (Array opcional com palavras-chave para busca avançada)
 */
...
const DATABASE = [
    ...
    },
    {
        ...
        correct: "Wado Ichimonji", // A mais icônica e a que pertenceu a Kuina
    ...
    },
    {
        ...
        correct: "Thousand Sunny", // A atual, mas a Going Merry é mais 'easy'? Vamos colocar a atual.
    ...
    },
    {
        ...
        correct: "Neto e Avô", // Joseph é avô de Jotaro (pai de Holly)
    ...
    // --- BLACK CLOVER (hd) ---
    {
        ...
        correct: "Espada Matadora de Demônios (Demonic Destroyer)", // A que anula magia é a Demon-Dweller? Revisão: A primeira é a Demon-Dweller (que absorve magia). A Demon-Destroyer anula efeitos. Vamos corrigir.
        correct: "Espada Habitadora do Demônio (Demon-Dweller)", // Esta é a primeira que ele pega e que anula magia.
    ...
    // --- PSYCHO-PASS (hd) ---
    {
        ...
        correct: "Shogo Makishima", // O Sistema é antagonista, mas Makishima é o agente principal da primeira temporada.
    ...
    // --- EXPANSÃO RÁPIDA (Adicionando variações para atingir escala) ---
    // Personagens, técnicas e lore de diversos animes para demonstrar volume.
    {
        id: "fairy_ez_002",
        level: "easy",
        type: "character",
    ...
    },
    {
        ...
        correct: "Um mistério (A Vontade de D.)", // Ainda é um mistério, a melhor resposta hardcore.
    ...
    },
    {
        ...
        correct: "Ela não tem (é Makima)", // Sim, Makima é seu nome real.
        tags: ["makima", "nome", "csm"]
    }
    // ... (O banco de dados continuaria até 5000+ com o mesmo padrão)
];
